...
RAM_E	equ	0FFFFH	; RAM END address
ENTRY	EQU	0040H		; Entry point

	IF SMEZ80Full = 0
RAM_B		equ	ENTRY	; work area base address
MON_SEG		equ	0d000h
SV_ROM		equ	60h	; SAVE addiress for monitor code at POWER ON
	ELSE
...
PATB_TOP	equ	4C00H
PATB_CST	equ	4C00H	; basic cold start
PATB_WST	equ	4C03H	; basic warm start
...
;	ORG	0038H
	...
	if (SuperMEZ80=1) && (SMEZ80Full=0)

	;; LOADER START
cold_st:
	ld	hl, CSTART
	ld	(1), hl		; set new COLD START

	ld	de, MON_SEG
	ld	hl, SV_ROM
	ld	bc, end_mon - MON_SEG
	ldir
	jp	CSTART
...
OPNMSG:
	...
	if SuperMEZ80
	db	"EMUZ80 MONITOR Rev.B04 for SuperMEZ80",CR,LF
	else
	db	"EMUZ80 MONITOR Rev.B04",CR,LF
	endif
